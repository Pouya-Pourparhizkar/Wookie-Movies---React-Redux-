...
- Implement assignment using:
  - Language: TypeScript
  - Framework: React
- Build out the project to the designs. Usability improvements are encouraged.
- Scale the solution for enterprise uses. You can add libraries to support your solution.
